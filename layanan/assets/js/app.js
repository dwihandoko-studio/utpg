    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "../../../theme/images/flags/us.jpg")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "../../../theme/images/flags/spain.jpg")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "../../../theme/images/flags/germany.jpg")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "../../../theme/images/flags/italy.jpg")
        : "ru" == e &&
          (document.getElementById("header-lang-img").src =
            "../../../theme/images/flags/russia.jpg"),
      localStorage.setItem("language", e),
      null == (t = localStorage.getItem("language")) && a(n),
      s.getJSON("../../../theme/lang/" + t + ".json", function (e) {
        s("html").attr("lang", t),
  ...
  function r(e) {
    1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (s("html").removeAttr("dir"),
        ...
        s("#bootstrap-style").attr("href", "../../../theme/css/bootstrap.min.css"),
        s("#app-style").attr("href", "../../../theme/css/app.min.css"),
      ...
      ? (s("html").removeAttr("dir"),
        ...
        s("#rtl-mode-switch").prop("checked", !1),
        s("#dark-rtl-mode-switch").prop("checked", !1),
        s("#bootstrap-style").attr("href", "../../../theme/css/bootstrap-dark.min.css"),
        s("#app-style").attr("href", "../../../theme/css/app-dark.min.css"),
        sessionStorage.setItem("is_visited", "dark-mode-switch"))
      : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e
      ? (s("#light-mode-switch").prop("checked", !1),
        s("#dark-mode-switch").prop("checked", !1),
        s("#dark-rtl-mode-switch").prop("checked", !1),
        s("#bootstrap-style").attr("href", "../../../theme/css/bootstrap-rtl.min.css"),
        s("#app-style").attr("href", "../../../theme/css/app-rtl.min.css"),
        s("html").attr("dir", "rtl"),
      ...
      : 1 == s("#dark-rtl-mode-switch").prop("checked") &&
        ...
        s("#bootstrap-style").attr(
          "href",
          "../../../theme/css/bootstrap-dark-rtl.min.css"
        ),
        s("#app-style").attr("href", "../../../theme/css/app-dark-rtl.min.css"),
        s("html").attr("dir", "rtl"),
